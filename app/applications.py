...
def apply_local(job_id):
    ...
    if not user_cv:
        flash("عذراً، يجب عليك رفع سيرتك الذاتية أولاً لتتمكن من التقديم والمطابقة الذكية.", "danger")
